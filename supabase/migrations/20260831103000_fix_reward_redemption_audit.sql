-- audit_logs stores location context in metadata and has no location_id
-- column. The invalid audit insert rolled back every otherwise valid reward
-- redemption.
