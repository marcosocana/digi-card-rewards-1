-- audit_logs does not have a location_id column. Keep location context in the
-- metadata object so queuing a valid manual notification remains atomic.
...
begin
  ...
  insert into public.audit_logs(
    ...
    auth.uid(),_organization_id,'notification_queued','notification',_notification,
    jsonb_build_object(
