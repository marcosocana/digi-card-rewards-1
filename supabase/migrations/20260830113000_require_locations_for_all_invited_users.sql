-- Every invited user belongs to one company and to one or more of its active
-- establishments, including company administrators.
...
begin
  ...
  if cardinality(_normalized_locations) = 0 then
