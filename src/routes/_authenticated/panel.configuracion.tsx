...
function ConfiguracionPage() {
  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      return { org: org.data, branding: branding.data };
    },
  });
      ...
      <Tabs defaultValue="business" className="space-y-4">
        ...
        <TabsContent value="wallet" className="surface p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Arquitectura y cola de actualización activas en modo demo. La emisión real requiere
            certificados de Apple y credenciales de Google configurados exclusivamente en backend.
          </p>
        </TabsContent>
