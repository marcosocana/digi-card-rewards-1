  ...
  public: {
    Tables: {
      ...
      notification_automations: {
        ...
        Relationships: [
          {
            foreignKeyName: "notification_automations_location_id_fkey";
            columns: ["location_id"];
            isOneToOne: false;
            referencedRelation: "locations";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      process_automation_jobs: {
        Args: { _limit?: number; _location_id?: string; _organization_id: string };
        Returns: Json;
      };
    ...
    Enums: {
      ...
      pass_status: "pending_generation" | "active" | "update_pending" | "error" | "revoked";
      platform_role: "superadmin" | "user";
      program_status: "draft" | "active" | "paused" | "archived";
      rounding_mode: "floor" | "nearest" | "decimal";
      txn_type:
        "purchase" | "redemption" | "manual_adjustment" | "reversal" | "initial_bonus" | "expiry";
